  ...
  calcularImpuesto() {
    if (this.salud <= 15238.60 && this.vivienda <= 3809.65 && this.educacion <= 3809.65 && this.vestimenta <= 3809.65 && this.alimentacion <= 3809.65) {
      ...
      if (this.gastosestado(this.totl)) {
        ...
        this.mensaje = `EL IMPUESTO A PAGAR ES: ${this.impuesto_renta}`;
      ...
      if (this.salud > 15238.60) {
        this.campoExcedido = 'Salud';
      } else if (this.vivienda > 3809.65) {
        this.campoExcedido = 'Vivienda';
      } else if (this.educacion > 3809.65) {
        this.campoExcedido = 'Educación';
      } else if (this.vestimenta > 3809.65) {
        this.campoExcedido = 'Vestimenta';
      } else if (this.alimentacion > 3809.65) {
        this.campoExcedido = 'Alimentación';
      }
      this.mensaje = `El campo ${this.campoExcedido} está excedido`;
    }
  }
